...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'post', 'content', self.gf('django.db.models.fields.CharField')(max_length=8192))

    def backwards(self, orm):

        # Changing field 'Post.content'
        db.alter_column(u'post', 'content', self.gf('django.db.models.fields.CharField')(max_length=4096))
